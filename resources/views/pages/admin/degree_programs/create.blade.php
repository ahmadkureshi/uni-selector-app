...
@section('title', 'Add New Degree Program')

@section('content')
    <div class="container mx-auto px-6 py-8">
        <h1 class="text-3xl font-semibold text-orange-400">Add New Degree Program</h1>

        {{-- Create University --}}
        <div class="mt-6 bg-black rounded shadow-md p-6">
            <form action="{{ route('backend.degree-programs.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" class="mt-2 w-full p-2 border rounded bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-orange-400">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="last_year_merit" id="last_year_merit" value="{{ old('last_year_merit') }}" class="mt-2 w-full p-2 border rounded bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-orange-400">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="fee" id="fee" value="{{ old('fee') }}" class="mt-2 w-full p-2 border rounded bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-orange-400">
